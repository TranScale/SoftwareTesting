        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    AdminGroupId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_AdminGroups_AdminGroupId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GroupPermissions_AdminGroups_AdminGroupId",
                        column: x => x.AdminGroupId,
                        principalTable: "AdminGroups",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StockOnHand = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LineTotal = table.Column<decimal>(type: "decimal(18,2)", nullable: false, computedColumnSql: "[UnitPrice] * [Quantity]", stored: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_AdminGroupId",
                table: "AspNetUsers",
                column: "AdminGroupId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupPermissions_AdminGroupId_Module_Action",
                table: "GroupPermissions",
                columns: new[] { "AdminGroupId", "Module", "Action" },
                unique: true);
